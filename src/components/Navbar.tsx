...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-gray-200 dark:bg-gray-900 bg-[#a2ca57]">
          ...
          >
            {navLinks.map((link) => (
              <li key={link.name}>
                ...
                dark:hover:text-white md:dark:hover:bg-transparent transition-colors duration-300"
                >
                  {link.name}
                </a>
              </li>
